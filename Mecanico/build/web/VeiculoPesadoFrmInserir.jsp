        ...
        <div class="container col-md-5">
            <div class="text-center">
                <div class="card-body forma">
                    <form action="<%=request.getContextPath()%>/veiculopesado?insert" method="post">
                        <caption>
                            <h2 style="text-align: center;">Adicionar Veiculo Pesado</h2>
                            <fieldset class="form-group p-1">
                                <label>idVeiculo</label> 
                                <input type="text"
                                       value="<vp:out value='${veiculopesado.idVeiculo}' />" class="form-control"
                                       name="idVeiculo" required="required">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>ComprimentoMetros</label> 
                                <input type="text" value="<vp:out value='${veiculopesado.comprimentoMetros}' />" class="form-control"
                                       name="comprimentoMetros">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>NumEixos</label> 
                                <input type="text"
                                       value="<vp:out value='${veiculopesado.numEixos}' />" class="form-control"
                                       name="numEixos" required="required">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>PesoToneladas</label> 
                                <input type="text"
                                       value="<vp:out value='${veiculopesado.pesoToneladas}' />" class="form-control"
                                       name="pesoToneladas" required="required">
                            </fieldset>
