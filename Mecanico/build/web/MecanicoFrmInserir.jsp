        ...
        <div class="container col-md-5">
            <div class="text-center">
                <div class="card-body forma">
                    <form action="<%=request.getContextPath()%>/mecanico?insert" method="post">
                        <caption>
                            <h2 style="text-align: center;">Adicionar Mecânico</h2>
                            ...
                            <fieldset class="form-group p-1">
                                <label>CREA</label> 
                                <input type="text" value="<m:out value='${mecanico.CREA}' />" class="form-control"
                                       name="CREA">
                            </fieldset>
                            <fieldset class="form-group p-1">
