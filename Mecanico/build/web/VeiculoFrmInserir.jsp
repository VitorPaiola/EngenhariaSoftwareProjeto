        ...
        <div class="container col-md-5">
            <div class="text-center">
                <div class="card-body forma">
                    <form action="<%=request.getContextPath()%>/veiculo?insert" method="post">
                        <caption>
                            <h2 style="text-align: center;">Adicionar Veiculo</h2>
                            <fieldset class="form-group p-1">
                                <label>idRevisao</label> 
                                <input type="text"
                            ...
                            <fieldset class="form-group p-1">
                                <label>idDono</label> 
                                <input type="text" value="<v:out value='${veiculo.idDono}' />" class="form-control"
                                       name="idDono">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>Placa</label> 
