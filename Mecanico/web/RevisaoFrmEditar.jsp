        ...
        <div class="container col-md-5">
            <div class="text-center">
                <div class="card-body forma">
                    <form action="<%=request.getContextPath()%>/revisao?update" method="post">
                        <caption>
                            <h2 style="text-align: center;">Editar Revisão</h2>
                            <input type="hidden" name="idRevisao" value="<r:out value='${revisao.idRevisao}' />" />
                            <fieldset class="form-group p-1">
                                <label>idMeca</label> 
                                <input type="text"
                                       value="<r:out value='${revisao.idMeca}' />" class="form-control"
                                       name="idMeca" required="required">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>Data</label> 
                                <input type="text" value="<r:out value='${revisao.datahora}' />" class="form-control"
                                       name="datahora">
                            </fieldset>
                            <fieldset class="form-group p-1">
                                <label>Relatorio</label> 
                                <input type="text"
                                       value="<r:out value='${revisao.relatorio}' />" class="form-control"
                                       name="relatorio" required="required">
                            </fieldset>
                            <button type="submit" class="btn btn-success estilo">Editar</button>
                    </form>
                </div>
            </div>
        </div>
