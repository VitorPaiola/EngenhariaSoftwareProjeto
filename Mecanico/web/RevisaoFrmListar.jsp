...
<html>
    ...
    <body>
        ...
        <br>
        <div class="container">
            <h3 class="text-center">Lista de Revisões</h3>
            <hr>
            <div class="container text-left">
                <a href="<%=request.getContextPath()%>/revisao?new" class="btn btn-success estilo">Incluir</a>
            </div>
            <br>
            <table class="table table-bordered">
                ...
                <tbody>                                          
                    <r:forEach var="revisao" items="${listRevisao}">
                        <tr>
                            <td><r:out value="${revisao.idRevisao}" /></td>
                            <td><r:out value="${revisao.idMeca}" /></td>
                            <td><r:out value="${revisao.datahora}" /></td>
                            <td><r:out value="${revisao.relatorio}" /></td>
                            <td>
                                <a href="<%=request.getContextPath()%>/revisao?edit=<r:out value='${revisao.idRevisao}' />" class="link">Editar</a>
                                &nbsp;&nbsp;&nbsp;&nbsp; 
                                <a href="<%=request.getContextPath()%>/revisao?delete=<r:out value='${revisao.idRevisao}' />" class="link">Remover</a></td>
                        </tr>
                    </r:forEach>
                </tbody>
            </table>
